...
- [Memory Management](../04-advanced/33-memory-management.md) — GC impact of string allocations
- [Collections Overview](./08-collections-overview.md) — char[] vs string storage
