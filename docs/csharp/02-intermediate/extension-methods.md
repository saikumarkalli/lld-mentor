...
### Extension Methods on Interfaces — The Power Move
...
## 🔗 Connected Topics
- [LINQ](./linq.md) — entirely built on extension methods over `IEnumerable<T>`
- [Delegates](./delegates.md) — LINQ extensions accept `Func<T, bool>` delegates
- [Generics](./generics.md) — most extension methods are generic
