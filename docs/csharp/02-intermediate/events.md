...
## 🔗 Connected Topics
- [Delegates](./delegates.md) — Events ARE delegates with access restrictions
- **Observer Pattern** → [`LLDMaster.Patterns/03_Behavioral/11_Observer/`](../../LLDMaster.Patterns/03_Behavioral/11_Observer/)
- [Memory Management](../03-advanced/memory-management.md) — Event subscription memory leaks
