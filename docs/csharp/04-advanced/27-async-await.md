...
- [Garbage Collection](../05-expert/40-garbage-collection.md) — Long-lived tasks affect GC pressure
- [Task Parallel Library](../05-expert/43-task-parallel-library.md) — Parallel.ForEachAsync, Dataflow
