...
## 🔗 Connected Topics
- [async/await](../03-advanced/async-await.md) — TPL is the foundation for async
- [GC](./garbage-collection.md) — Parallel work increases allocation rate → GC pressure
- [Deadlocks](../03-advanced/deadlocks.md) — Parallel work can deadlock if locking incorrectly
