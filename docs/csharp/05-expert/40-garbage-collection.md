...
- [async/await](../04-advanced/27-async-await.md) — async state machines allocate; ValueTask reduces GC load
- [CLR Internals](./41-clr-internals.md) — GC is a subsystem of the CLR
- [Performance Tuning](./44-performance-tuning.md) — GC tuning is a core part of .NET perf work
