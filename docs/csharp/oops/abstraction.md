...
> 🔗 **Code Implementation:** [`LLDMaster.OOP/2.Abstraction/`](../../LLDMaster.OOP/2.Abstraction/)
...
// Reference: LLDMaster.Patterns/03_Behavioral/15_TemplateMethod/
```
...
## 🔗 Connected Topics
- [Encapsulation](./encapsulation.md) | [Inheritance](./inheritance.md) | [Polymorphism](./polymorphism.md)
- [Delegates](../02-intermediate/delegates.md) — Functional abstraction alternative to interfaces
- [`LLDMaster.SOLID/`](../../LLDMaster.SOLID/) — DIP is all about abstracting via interfaces
- [`LLDMaster.Patterns/01_Creational/`](../../LLDMaster.Patterns/01_Creational/) — Abstract Factory uses abstraction heavily

*Created: April 2026 · Code Reference: [`LLDMaster.OOP/2.Abstraction/`](../../LLDMaster.OOP/2.Abstraction/)*
