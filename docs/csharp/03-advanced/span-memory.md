...
## 🔗 Connected Topics
- [Value vs Reference Types](../01-beginner/value-vs-reference-types.md) — Span is a value type (ref struct)
- [Garbage Collection](../04-expert/garbage-collection.md) — Span avoids heap allocations entirely
- [Memory Management](./memory-management.md) — MemoryPool<T>, IMemoryOwner<T>
- [async/await](./async-await.md) — Memory<T> crosses await boundaries; Span cannot
